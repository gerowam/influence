...
--sigma_mu=0.0001 \
--alpha=0.01 \
--minimize_phi_iterations=true \
--lda_sequence_min_iter=4 \
--lda_sequence_max_iter=15 \
--save_time=-1 \
--outname=${ODIR} \
--ntopics=${K} \
...
#--read_hdf_term1=/home/gerow/files/influence_models/influence/dtm-dim/outputs/full_acl_eq32_term1.h5 \
#--initial_lda_ss=${PWD}/../acl_arf-test_data/k2-initial-lda-ss.dat \

#--checkpoint_outdir=${ODIR}/checkpoints/ \
#--checkpoint_recover=${ODIR}/../pivottest-checkpointed/checkpoints/iter-4/ \
